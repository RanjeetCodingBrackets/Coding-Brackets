      ...
      >
        ...
        <div className="grid grid-cols-4 place-items-center align-middle px-16 gap-12">
          {services.map((service) => (
            <div
              key={service.id}
              className="flex flex-col h-full group space-y-5 text-center align-middle justify-center items-center bg-white py-12 px-7 rounded-2xl border border-gray-100 shadow-md hover:-translate-y-1 hover:shadow-lg hover:shadow-cyan-300 transition-all duration-300 ease-in-out"
            >
              <div
